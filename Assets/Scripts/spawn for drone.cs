...
public class PuddleSpawnerV2 : MonoBehaviour
{
    [Header("References")]
    ...
    [Tooltip("Height offset to spawn puddles above the ground.")]
    ...
    void SpawnRow(float zPos)
    {
        ...
        Vector3 spawnPos = new Vector3(xPos, spawnHeightOffset, zPos);
